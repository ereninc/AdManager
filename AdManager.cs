...
{
    string App_ID = "ca-app-pub-XXX"; //from the admob.
    string Interstitial_Ad_ID = "ca-app-pub-XXX"; //ad's id
    string App_IDtest = "ca-app-pub-39402560999425441033173712"; //global test id
    ...
    void Start()
    {
        MobileAds.Initialize(App_ID); app id
        RequestInterstitial();
    }
